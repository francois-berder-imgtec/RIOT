...
#define LATx(P)         (base_address[P][0x10/0x4])
#define LATxCLR(P)      (base_address[P][0x14/0x4])
#define LATxSET(P)      (base_address[P][0x18/0x4])
#define LATxINV(P)      (base_address[P][0x1C/0x4])
#define PORTx(P)        (base_address[P][0x0])
#define ANSELxCLR(P)    (base_address[P][(-0x20 + 0x4)/0x4])
#define CNPUxCLR(P)     (base_address[P][0x34/0x4])
#define CNPUxSET(P)     (base_address[P][0x38/0x4])
#define CNPDxCLR(P)     (base_address[P][0x44/0x4])
#define CNPDxSET(P)     (base_address[P][0x48/0x4])
#define ODCxCLR(P)      (base_address[P][0x24/0x4])
#define ODCxSET(P)      (base_address[P][0x28/0x4])
#define TRISxCLR(P)     (base_address[P][(-0x10 + 0x4)/0x4])
#define TRISxSET(P)     (base_address[P][(-0x10 + 0x8)/0x4])


static volatile uint32_t* base_address[] = {
#ifdef _PORTA_BASE_ADDRESS
    (volatile uint32_t*)_PORTA_BASE_ADDRESS,
#else
    0,
#endif
#ifdef _PORTB_BASE_ADDRESS
    (volatile uint32_t*)_PORTB_BASE_ADDRESS,
#else
    0,
#endif
#ifdef _PORTC_BASE_ADDRESS
    (volatile uint32_t*)_PORTC_BASE_ADDRESS,
#else
    0,
#endif
#ifdef _PORTD_BASE_ADDRESS
    (volatile uint32_t*)_PORTD_BASE_ADDRESS,
#else
    0,
#endif
#ifdef _PORTE_BASE_ADDRESS
    (volatile uint32_t*)_PORTE_BASE_ADDRESS,
#else
    0,
#endif
#ifdef _PORTF_BASE_ADDRESS
    (volatile uint32_t*)_PORTF_BASE_ADDRESS,
#else
    0,
#endif
#ifdef _PORTG_BASE_ADDRESS
    (volatile uint32_t*)_PORTG_BASE_ADDRESS,
#else
    0,
#endif
};
